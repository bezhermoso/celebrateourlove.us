...
Markers.ceremony = {
  coordinates: function () {
    return new google.maps.LatLng(10.331121, 123.900536);
  },
  labelAnchor: function () {
    return new google.maps.Point(29, 20);
  },
  infoWindow: function () {
...
Markers.reception = {
  coordinates: function () {
    return new google.maps.LatLng(10.307879, 124.019479);
  },
  labelAnchor: function () {
    return new google.maps.Point(29, 20);
  },
  ...
  options : {
    ...
    raiseOnDrag: false,
    icon: ' ',
    labelContent: '<div class="de-icon circle medium-size" style="background-color:#FFF; border:1px solid #f0394d"><i class="de-icon-food" style="color:#f0394d"></i></div>',
    labelClass: "labels" // the CSS class for the label
  }
};
